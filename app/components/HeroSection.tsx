...
const HeroSection = () => {
  const slides = [
    ...
    },
    {
      ...
      btnText: "Order Now",
      bg: "https://images.unsplash.com/photo-1766421687400-e7e742d6f39d?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fEZhc3QlMjAlMjYlMjBSZWxpYWJsZSUyMERlbGl2ZXJ5fGVufDB8fDB8fHww",
    },
    {
      id: 3,
      icon: (
      ...
      btnText: "Get Started",
      bg: "https://plus.unsplash.com/premium_photo-1742420854807-505e50053615?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGZyZXNoJTIwZ3JvY2VyeXxlbnwwfHwwfHx8MA%3D%3D",
    },
  ];
  useEffect(() => {
      ...
      <div className="absolute inset-0 flex items-center justify-center text-center text-white px-6">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            className="mt-4 bg-white cursor-pointer text-green-700 hover:bg-green-100 px-8 py-3 rounded-full font-semibold
